...
import com.cts.apigateway.exception.JwtTokenMalformedException;
import com.cts.apigateway.exception.JwtTokenMissingException;
import com.cts.apigateway.jwt.JwtUtil;
...
public class LoggingFilter implements GatewayFilter {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		apiEndpoints.add("pensioner-detail-service/pensionerDetailByAadhaar/{aadhaarNumber}");
