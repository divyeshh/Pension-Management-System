...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorResponseNoFieldErrors> handleFeignStatusException(FeignException exception,
		...
		return new ResponseEntity<ErrorResponseNoFieldErrors>(errorResponse, HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ErrorResponse> handleInvalidTokenException(InvalidTokenException exception,
		...
		log.debug("Message: {}", exception.getMessage());
		return new ResponseEntity<ErrorResponse>(new ErrorResponse(exception.getMessage()), HttpStatus.FORBIDDEN);
	}
